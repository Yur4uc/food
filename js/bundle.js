...
function cards() {
    ...
    new MenuCard(
        ...
        "elite",
        'Меню “Преміум”',
        'В меню “Преміум” ми використовуємо не лише гарний дизайн упаковки, але й якісне виконання страв. Червона риба, морепродукти, фрукти – ресторанне меню без походу в ресторан!',
        21,
        ".menu .container"
    ).render();
}
...
function forms() {
    ...
    const postData = async (url, data) => {
        const res = await fetch(url, { // запрос який йде на сервер
            method: 'POST',
                headers: {
...
function modal() {
    ...
    // Змінив значення щоб не відволікало
